...
* Capabilities available to SecureDroid in ordinary application mode.

* 

* NORMAL mode does not have Device Owner or system privileges.

* Capabilities reported here must therefore remain within the

* Android application sandbox and public Android APIs.
  */
