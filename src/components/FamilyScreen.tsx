    ...
    return (
        <div
            className={`min-h-full pb-24 transition-colors ${
                isLight ? 'bg-zinc-50 text-zinc-900' : 'bg-slate-950 text-zinc-100'
            }`}
        >
            <SecureDroidTopBar
            ...
            <div className="p-4 space-y-4 max-w-7xl mx-auto">
                ...
                <div className="space-y-2.5">
                    <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-zinc-200">Device Monitoring</p>
                                <p className="text-xs text-slate-400 mt-0.5">
                                    Monitor security across multiple devices in your family
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-zinc-200">Shared Protection</p>
                                <p className="text-xs text-slate-400 mt-0.5">
                                    Share DNS filtering policies and blocklists across devices
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-zinc-200">Real-time Alerts</p>
                                <p className="text-xs text-slate-400 mt-0.5">
                                    Receive alerts for new app installations and security events
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-zinc-200">Multi-Device Management</p>
                                <p className="text-xs text-slate-400 mt-0.5">
                                    Manage permissions and security settings across all devices
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-4 rounded-xl bg-slate-900/30 border border-slate-800/50">
                    <div className="flex items-center gap-3 p-2 rounded-lg bg-slate-800/30">
                        <div className="w-10 h-10 rounded-full bg-sky-500/20 flex items-center justify-center text-sm font-bold text-sky-400">
                            Y
                        </div>
                        <div className="flex-1">
                            <p className="text-sm font-medium text-zinc-200">You</p>
                            <p className="text-xs text-slate-400">Pixel 7 Pro • Protected</p>
                        </div>
                        <SecureDroidStatusChip status="Connected" isLight={isLight} size="sm" />
                    </div>
                    ...
                    <div className="flex items-center gap-3 p-2 rounded-lg bg-slate-800/20 mt-2 opacity-60">
                        ...
                        <div className="flex-1">
                            <p className="text-sm font-medium text-zinc-400">Sarah</p>
                            <p className="text-xs text-slate-500">Galaxy S23 • Invite pending</p>
                        </div>
                    ...
                    <div className="flex items-center gap-3 p-2 rounded-lg bg-slate-800/20 mt-2 opacity-40">
                        ...
                        <div className="flex-1">
                            <p className="text-sm font-medium text-zinc-500">John</p>
                            <p className="text-xs text-slate-500">iPhone 14 • Invite sent</p>
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-amber-400/70 mt-1 leading-relaxed">
                                Family Protection is currently in development. We're building a secure way
                                to monitor and protect your entire family's devices. Stay tuned for updates.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                    <SecureDroidButton
                        onClick={() => alert('This feature is coming soon. Stay tuned!')}
                        className="flex-1"
                        icon={Bell}
                    >
                ...
                <div className="text-center text-[10px] text-slate-500 pt-2">
                    Family Protection • v1.0.0 (Coming Soon)
                </div>
            </div>
        </div>
    );
